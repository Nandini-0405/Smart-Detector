...
irregular_threshold = 15  # Consecutive frames of irregular movement to trigger alert
normal_threshold = 15     # Consecutive frames of normal movement to reset alert
